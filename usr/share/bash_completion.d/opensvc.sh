...
svcmgr_monitor="--color --debug --env --interval --local --namespace --node --stats --status --waitlock -h --help -p --parallel -s --service -w --watch"
...
nodemgr_compliance_fix="--attach --color --debug --filter --force --format --local --module --moduleset --node --ruleset-date -h --help"
nodemgr_compliance_list_moduleset="--color --debug --filter --format --local --moduleset --node -h --help"
nodemgr_compliance_detach="--color --debug --filter --format --local --moduleset --node --ruleset -h --help"
nodemgr_compliance_attach="--color --debug --filter --format --local --moduleset --node --ruleset -h --help"
nodemgr_compliance_show_ruleset="--color --debug --filter --format --local --node -h --help"
nodemgr_compliance_env="--color --debug --filter --format --local --module --moduleset --node -h --help"
nodemgr_compliance_show_status="--color --debug --filter --format --local --node -h --help"
nodemgr_compliance_list_ruleset="--color --debug --filter --format --local --node --ruleset -h --help"
nodemgr_compliance_fixable="--attach --color --debug --filter --force --format --local --module --moduleset --node --ruleset-date -h --help"
nodemgr_compliance_list_module="--color --debug --filter --format --local --node -h --help"
nodemgr_compliance_show_moduleset="--color --debug --filter --format --local --node -h --help"
nodemgr_compliance_check="--attach --color --debug --filter --force --format --local --module --moduleset --node --ruleset-date -h --help"
nodemgr_compliance_auto="--color --cron --debug --filter --format --local --node -h --help"
nodemgr_prkey="--color --debug --filter --format --local --node -h --help"
nodemgr_pushnsr="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pushcentera="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pushibmds="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pushhp3par="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pushxtremio="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pushpatch="--color --cron --debug --filter --format --local --node -h --help"
nodemgr_pushpkg="--color --cron --debug --filter --format --local --node -h --help"
nodemgr_pushvioserver="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pushasset="--color --cron --debug --filter --format --local --node --sync -h --help"
nodemgr_pushibmsvc="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pushnetapp="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pushgcedisks="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pusheva="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pushnecism="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pushbrocade="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_sysreport="--color --cron --debug --filter --force --format --local --node -h --help"
nodemgr_pushemcvnx="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pushfreenas="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pushhds="--color --cron --debug --filter --format --local --node --object -h --help"
nodemgr_pushstats="--begin --color --cron --debug --end --filter --format --local --node --stats-dir -h --help"
nodemgr_pushsym="--color --cron --debug --filter --format --local --node --object --symcli-db-file -h --help"
nodemgr_checks="--color --cron --debug --filter --format --local --node -h --help"
nodemgr_pushdisks="--color --cron --debug --filter --format --local --node -h --help"
nodemgr_pool_create_volume="--access --color --debug --filter --format --local --name --namespace --node --pool --shared --size -h --help"
nodemgr_pool_ls="--color --debug --filter --format --local --node -h --help"
nodemgr_pool_status="--color --debug --filter --format --local --node --pool -h --help"
nodemgr_set="--add --color --debug --eval --filter --format --index --kw --local --node --param --remove --value -h --help"
nodemgr_unset="--color --debug --filter --format --kw --local --node --param -h --help"
nodemgr_eval="--color --debug --filter --format --impersonate --kw --local --node -h --help"
nodemgr_get="--color --debug --eval --filter --format --impersonate --kw --local --node --param -h --help"
nodemgr_edit_config="--color --debug --discard --filter --format --local --node --recover -h --help"
nodemgr_register="--app --color --debug --filter --format --local --node --password --user -h --help"
nodemgr_validate_config="--color --debug --filter --format --local --node -h --help"
nodemgr_print_config="--color --debug --filter --format --local --node -h --help"
nodemgr_delete="--color --debug --filter --format --kw --local --node -h --help"
nodemgr_logs="--backlog --color --debug --filter --follow --format --local --node -h --help"
nodemgr_auto_reboot="--color --cron --debug --filter --format --local --node -h --help"
nodemgr_freeze="--color --debug --filter --format --local --node --time --wait -h --help"
nodemgr_schedule_reboot="--color --debug --filter --format --local --node -h --help"
nodemgr_shutdown="--color --debug --filter --format --local --node -h --help"
nodemgr_array="--color --debug --filter --format --local --node -h --help"
nodemgr_scanscsi="--color --debug --filter --format --hba --local --lun --node --target -h --help"
nodemgr_unsnooze="--color --debug --filter --format --local --node -h --help"
nodemgr_unschedule_reboot="--color --debug --filter --format --local --node -h --help"
nodemgr_ping="--color --debug --filter --format --local --node -h --help"
nodemgr_reboot="--color --debug --filter --format --local --node -h --help"
nodemgr_wol="--broadcast --color --debug --filter --format --local --mac --node --port -h --help"
nodemgr_collect_stats="--color --cron --debug --filter --format --local --node -h --help"
nodemgr_ls="--color --debug --filter --format --local --node -h --help"
nodemgr_events="--color --debug --filter --format --local --node -h --help"
nodemgr_thaw="--color --debug --filter --format --local --node --time --wait -h --help"
nodemgr_schedule_reboot_status="--color --debug --filter --format --local --node -h --help"
nodemgr_print_devs="--color --debug --dev --filter --format --local --node --reverse --verbose -h --help"
nodemgr_dequeue_actions="--color --cron --debug --filter --format --local --node -h --help"
nodemgr_snooze="--color --debug --duration --filter --format --local --node -h --help"
nodemgr_wait="--color --debug --duration --filter --format --local --node -h --help"
nodemgr_updatepkg="--color --debug --filter --format --local --node -h --help"
nodemgr_frozen="--color --debug --filter --format --local --node -h --help"
nodemgr_stonith="--color --debug --filter --format --local --node -h --help"
nodemgr_rotate_root_pw="--color --cron --debug --filter --format --local --node -h --help"
nodemgr_updatecomp="--color --debug --filter --format --local --node -h --help"
nodemgr_print_schedule="--color --debug --filter --format --local --node --verbose -h --help"
nodemgr_daemon_join="--color --debug --filter --format --local --node --secret -h --help"
nodemgr_daemon_blacklist_clear="--color --debug --filter --format --local --node -h --help"
nodemgr_dns_dump="--color --debug --filter --format --local --node -h --help"
nodemgr_daemon_restart="--color --debug --filter --format --local --node -h --help"
nodemgr_daemon_relay_status="--color --debug --filter --format --local --node -h --help"
nodemgr_daemon_start="--color --debug --filter --format --local --node --thread-id -h --help"
nodemgr_daemon_shutdown="--color --debug --filter --format --local --node -h --help"
nodemgr_daemon_stats="--color --debug --filter --format --local --node -h --help"
nodemgr_daemon_stop="--color --debug --filter --format --local --node --thread-id -h --help"
nodemgr_daemon_running="--color --debug --filter --format --local --node -h --help"
nodemgr_daemon_status="--color --debug --filter --format --local --node -h --help"
nodemgr_daemon_leave="--color --debug --filter --format --local --node -h --help"
nodemgr_daemon_rejoin="--color --debug --filter --format --local --node -h --help"
nodemgr_daemon_blacklist_status="--color --debug --filter --format --local --node -h --help"
nodemgr_daemon_lock_release="--color --debug --filter --format --id --local --name --node -h --help"
nodemgr_network_setup="--color --debug --filter --format --local --node -h --help"
nodemgr_network_ls="--color --debug --filter --format --local --node -h --help"
nodemgr_network_show="--color --debug --filter --format --local --name --node -h --help"
nodemgr_network_status="--color --debug --filter --format --local --name --node --verbose -h --help"
nodemgr_collector_list_tags="--color --debug --filter --format --like --local --node -h --help"
nodemgr_collector_disks="--color --debug --filter --format --local --node -h --help"
nodemgr_collector_log="--color --debug --filter --format --local --message --node -h --help"
nodemgr_collector_events="--begin --color --debug --end --filter --format --local --node -h --help"
nodemgr_collector_search="--color --debug --filter --format --like --local --node -h --help"
nodemgr_collector_list_filtersets="--color --debug --filter --format --local --node -h --help"
nodemgr_collector_list_actions="--begin --color --debug --end --filter --format --local --node -h --help"
nodemgr_collector_cli="--api --color --config --debug --filter --format --insecure --local --node --password --refresh-api --save --user -h --help"
nodemgr_collector_tag="--color --debug --filter --format --local --node --tag -h --help"
nodemgr_collector_list_services="--color --debug --filter --format --local --node -h --help"
nodemgr_collector_networks="--color --debug --filter --format --local --node -h --help"
nodemgr_collector_untag="--color --debug --filter --format --local --node --tag -h --help"
nodemgr_collector_show_actions="--begin --color --debug --end --filter --format --id --local --node -h --help"
nodemgr_collector_checks="--color --debug --filter --format --local --node -h --help"
nodemgr_collector_show_tags="--color --debug --filter --format --local --node -h --help"
nodemgr_collector_create_tag="--color --debug --filter --format --local --node --tag -h --help"
nodemgr_collector_list_nodes="--color --debug --filter --format --local --node -h --help"
nodemgr_collector_ack_action="--author --color --comment --debug --filter --format --local --node -h --help"
nodemgr_collector_alerts="--color --debug --filter --format --local --node -h --help"
nodemgr_collector_asset="--color --debug --filter --format --local --node -h --help"
