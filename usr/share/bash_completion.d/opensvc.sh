...
svcmgr_edit_config="--color --debug --discard --env --local --namespace --node --recover --status --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_validate_config="--color --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_create="--color --config --debug --disable-rollback --dry-run --env --kw --leader --local --master --namespace --node --nolock --provision --resource --restore --rid --slave --slaves --status --subsets --tags --template --waitlock -c --cluster -f --force -h --help -i --interactive -p --parallel -s --service"
svcmgr_print_config="--color --debug --env --eval --filter --format --impersonate --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_compliance_fix="--attach --color --debug --env --local --module --moduleset --namespace --node --ruleset-date --status --waitlock -c --cluster -f --force -h --help -p --parallel -s --service"
svcmgr_compliance_list_moduleset="--color --debug --env --local --moduleset --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_compliance_detach="--color --debug --env --local --moduleset --namespace --node --ruleset --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_compliance_attach="--color --debug --env --local --moduleset --namespace --node --ruleset --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_compliance_show_ruleset="--color --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_compliance_env="--color --debug --env --local --module --moduleset --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_compliance_show_status="--color --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_compliance_list_ruleset="--color --debug --env --local --namespace --node --ruleset --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_compliance_fixable="--attach --color --debug --env --local --module --moduleset --namespace --node --ruleset-date --status --waitlock -c --cluster -f --force -h --help -p --parallel -s --service"
svcmgr_compliance_show_moduleset="--color --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_compliance_check="--attach --color --debug --env --local --module --moduleset --namespace --node --ruleset-date --status --waitlock -c --cluster -f --force -h --help -p --parallel -s --service"
svcmgr_compliance_auto="--attach --color --cron --debug --env --local --module --moduleset --namespace --node --ruleset-date --status --waitlock -c --cluster -f --force -h --help -p --parallel -s --service"
svcmgr_collector_disks="--color --debug --env --filter --format --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_log="--color --debug --env --local --message --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_networks="--color --debug --env --filter --format --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_list_actions="--begin --color --debug --end --env --filter --format --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_checks="--color --debug --env --filter --format --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_tag="--color --debug --env --local --namespace --node --status --tag --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_ack_unavailability="--account --author --begin --color --comment --debug --duration --end --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_list_tags="--color --debug --env --filter --format --like --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_untag="--color --debug --env --local --namespace --node --status --tag --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_show_actions="--begin --color --debug --end --env --filter --format --id --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_show_tags="--color --debug --env --filter --format --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_list_unavailability_ack="--author --begin --color --comment --debug --end --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_create_tag="--color --debug --env --local --namespace --node --status --tag --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_ack_action="--author --color --comment --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_alerts="--color --debug --env --filter --format --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_events="--begin --color --debug --end --env --filter --format --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_collector_asset="--color --debug --env --filter --format --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_push_encap_config="--color --cron --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_move="--color --debug --disable-rollback --env --interval --local --namespace --node --stats --status --time --to --wait --waitlock -c --cluster -h --help -p --parallel -s --service -w --watch"
...
svcmgr_push_resinfo="--color --cron --debug --env --local --namespace --node --status --sync --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_unsnooze="--color --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_monitor="--color --debug --env --interval --local --namespace --node --stats --status --waitlock -c --cluster -h --help -p --parallel -s --service -w --watch"
...
svcmgr_support="--color --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_ls="--color --debug --env --filter --format --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_push_status="--color --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_print_status="--color --debug --env --filter --format --hide-disabled --local --namespace --node --show-disabled --status --waitlock -c --cluster -h --help -p --parallel -r --refresh -s --service"
svcmgr_enable="--color --debug --env --local --namespace --node --rid --status --subsets --tags --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_print_exposed_devs="--color --debug --env --filter --format --local --namespace --node --rid --status --subsets --tags --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_print_resinfo="--color --debug --env --filter --format --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_print_devs="--color --debug --env --filter --format --local --namespace --node --rid --status --subsets --tags --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_pull="--color --debug --disable-rollback --env --local --namespace --node --provision --status --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_install_data="--color --debug --env --local --namespace --node --rid --status --subsets --tags --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_abort="--color --debug --env --interval --local --namespace --node --stats --status --time --wait --waitlock -c --cluster -h --help -p --parallel -s --service -w --watch"
svcmgr_print_sub_devs="--color --debug --env --filter --format --local --namespace --node --rid --status --subsets --tags --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_push_config="--color --cron --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_status="--color --cron --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -r --refresh -s --service"
...
svcmgr_migrate="--color --debug --disable-rollback --env --interval --local --namespace --node --stats --status --time --to --wait --waitlock -c --cluster -h --help -p --parallel -s --service -w --watch"
...
svcmgr_print_config_mtime="--color --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_giveback="--color --debug --disable-rollback --env --interval --local --namespace --node --stats --status --time --wait --waitlock -c --cluster -h --help -p --parallel -s --service -w --watch"
...
svcmgr_print_resource_status="--color --debug --env --filter --format --local --namespace --node --rid --status --waitlock -c --cluster -h --help -p --parallel -r --refresh -s --service"
...
svcmgr_prstatus="--color --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_print_base_devs="--color --debug --env --filter --format --local --namespace --node --rid --status --subsets --tags --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_deploy="--color --config --debug --disable-rollback --dry-run --env --kw --leader --local --master --namespace --node --nolock --restore --rid --slave --slaves --status --subsets --tags --template --waitlock -c --cluster -f --force -h --help -i --interactive -p --parallel -s --service"
...
svcmgr_podman="--color --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_takeover="--color --debug --disable-rollback --env --interval --local --namespace --node --stats --status --time --wait --waitlock -c --cluster -h --help -p --parallel -s --service -w --watch"
svcmgr_snooze="--color --debug --duration --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_frozen="--color --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
...
svcmgr_switch="--color --debug --disable-rollback --env --interval --local --namespace --node --stats --status --time --to --wait --waitlock -c --cluster -h --help -p --parallel -s --service -w --watch"
svcmgr_disable="--color --debug --env --local --namespace --node --rid --status --subsets --tags --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_print_schedule="--color --debug --env --filter --format --local --namespace --node --status --verbose --waitlock -c --cluster -h --help -p --parallel -s --service"
svcmgr_docker="--color --debug --env --local --namespace --node --status --waitlock -c --cluster -h --help -p --parallel -s --service"
